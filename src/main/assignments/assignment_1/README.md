...
4. Run the project:
    ...
    ```bash
    mvn exec:java -Dexec.mainClass="assignment_1.Main"
    ```
...
```java
import assignment_1.CinemaConfig;

CinemaConfig cfg = CinemaConfig.getInstance();
cfg.

setName("Festival Cinema");
cfg.

setScreens(10);
cfg.

setWorkHours("10 AM - 11 PM");
```

### Creating assignment_1.Movies
```java
